      ...
      <div className="donate__panel">
        <div className="donate__text">
          ...
          <div className="donate__actions">
            <a href="https://hakeela.org" target="_blank" rel="noopener noreferrer" className="donate__btn donate__btn--solid">
              Donate
            </a>
            <a href="https://hakeela.org/about" target="_blank" rel="noopener noreferrer" className="donate__btn donate__btn--outline">
              Learn More
