...
const resources = [
  ...
  { label: 'Our team', href: `${SITE}/about`, external: true },
  { label: 'Donate', href: '#' },
]
const contacts = [
...
const socials = [
  { label: 'Facebook', path: 'M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07Z' },
  { label: 'Twitter', path: 'M23.95 4.57a10 10 0 0 1-2.83.78 4.94 4.94 0 0 0 2.16-2.72 9.86 9.86 0 0 1-3.13 1.2 4.92 4.92 0 0 0-8.39 4.49A13.98 13.98 0 0 1 1.67 3.15a4.92 4.92 0 0 0 1.52 6.57 4.9 4.9 0 0 1-2.23-.62v.06a4.93 4.93 0 0 0 3.95 4.83 4.94 4.94 0 0 1-2.22.08 4.93 4.93 0 0 0 4.6 3.42A9.88 9.88 0 0 1 0 19.54 13.94 13.94 0 0 0 7.55 21.75c9.05 0 14-7.5 14-14 0-.21 0-.42-.02-.63a9.94 9.94 0 0 0 2.46-2.55Z' },
      ...
      <div className="container footer__inner">
        ...
        <nav aria-label="Quick Links">
          ...
          <ul className="footer__list">
            {quickLinks.map((l) => <li key={l.label}><a className="footer__link" href={l.href} {...ext(l)}>{l.label}</a></li>)}
          </ul>
        </nav>
        ...
        <nav aria-label="Resources">
          ...
          <ul className="footer__list">
            {resources.map((l) => <li key={l.label}><a className="footer__link" href={l.href} {...ext(l)}>{l.label}</a></li>)}
          </ul>
        </nav>
