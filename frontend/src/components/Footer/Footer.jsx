...
const quickLinks = [
  {
    label: 'HakPortal',
    href: 'https://hakportal.hakeela.org',
    external: true,
  },
  {
    label: 'Hak-AbilityTech',
  ...
  {
    label: 'HakVersity',
    href: 'https://hakversity.hakeela.org',
    external: true,
  },
]
      ...
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          ...
          <div className="footer__socials" aria-label="Social links">
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/hakeelaorg"
              target="_blank"
            ...
            >
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M18.244 2.25h3.308l-7.227 8.26L22.827 21.75h-6.604l-5.17-6.755-5.918 6.755H1.827l7.73-8.835L1.17 2.25H7.94l4.673 6.169L18.244 2.25Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z" />
              </svg>
            </a>

            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/hakeela/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="footer__social"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/hakeela_org"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* YouTube */}
            <a
              href="https://youtube.com/@hakeelaorg"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="footer__social"
